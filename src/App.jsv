...
const LifeAccountingApp = () => {
  ...
  const profiles = [
    { id: 'general', name: 'General', icon: '👤', description: 'Standard tracking' },
    { id: 'single-parent', name: 'Single Parent', icon: '👨‍👧', description: 'Balance caregiving, rest, work' },
    { id: 'entrepreneur', name: 'Entrepreneur', icon: '💼', description: 'Track billable hours, burnout risk' },
    { id: 'student', name: 'Student', icon: '📚', description: 'Manage study vs screen time' },
    { id: 'unemployed', name: 'Unemployed', icon: '🎯', description: 'Structure productive routines' }
  ];
  ...
  const maslowAccounts = [
    { id: 'survival', name: 'Survival', icon: '🍎', fullName: 'Physiological', description: 'Sleep, food, exercise' },
    { id: 'security', name: 'Security', icon: '🏠', fullName: 'Safety & Stability', description: 'Financial, health, routines' },
    { id: 'belonging', name: 'Belonging', icon: '❤️', fullName: 'Love & Connection', description: 'Relationships, community' },
    { id: 'esteem', name: 'Esteem', icon: '⭐', fullName: 'Self-Worth', description: 'Confidence, achievements' },
    { id: 'actualization', name: 'Actualization', icon: '✨', fullName: 'Purpose & Growth', description: 'Creativity, legacy' }
  ];
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 mb-6">
            ...
            {todayReflection ? (
              <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200">
                <p className="text-sm font-semibold text-indigo-900 mb-2">✓ Reflected today</p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-2 flex-wrap">
                          <span className={`${cat.color} text-white text-xs px-2 py-1 rounded-full font-semibold`}>
                            {cat.name} {cat.type === 'deposit' ? '📈' : cat.type === 'withdrawal' ? '📉' : ''}
                          </span>
